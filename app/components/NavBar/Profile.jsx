...
import { profileLinks } from "@utils/nav/profile-links"
...
function Profile(props) {
  ...
  useEffect(() => {
    function handleClickOutside(event) {
      if (
        ...
        !event.target.closest(".menu-shadow")
      ) {
        setShowMenu(false)
      }
    }
  ...
  return (
    <div ref={profileRef} className="relative">
      ...
      />
      {showMenu && (
        <div className="menu-shadow flex flex-col text-sm justify-center font-light text-black gap-[20px] absolute top-12 right-10 rounded-xl bg-white h-[215px] w-[200px] px-6">
